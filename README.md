...
### Argumets
- `n_philo`: Number of philosophers and forks used on the simulation
- `death_time`: Time in miliseconds before a philosophers dies if they haven't eaten
- `eat_time`: Time in miliseconds a philosopher takes to eat
- `tsleep_time`: Time in miliseconds a philosophers takes to sleep
- `n_meals`: Number of times all philosophers should eat to stop the simultaion (Optional argument)
